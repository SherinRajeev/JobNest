...
import { PlusCircle, MapPin, DollarSign, Clock, Layers, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="container" style={{ paddingTop: '2.5rem', maxWidth: '780px' }}>
      <div className="card-glass">
        <h1 style={{ fontSize: '1.8rem', marginBottom: '0.5rem' }}>Post a <span className="gradient-text">Part-Time Job</span></h1>
        <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>Fill in position details to broadcast your shift to nearby job seekers.</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
            <div className="form-group">
              <label className="form-label">Job / Shift Title *</label>
              <input
                type="text"
                placeholder="e.g. Weekend Barista & Shift Support"
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                placeholder="e.g. Artisan Brews Cafe"
          ...
          <div className="form-group">
            ...
            <textarea
              rows="4"
              placeholder="Describe the duties, work atmosphere, and shift responsibilities..."
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              placeholder="e.g. Espresso machine experience, Friendly demeanor, Weekend availability"
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              placeholder="e.g. Free meals, Cash tips, Employee discounts"
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
            <button type="submit" className="btn btn-primary btn-full" disabled={loading}>
              {loading ? 'Publishing...' : <>Publish Part-Time Shift <PlusCircle size={18} /></>}
            </button>
